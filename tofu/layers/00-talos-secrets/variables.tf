...
variable "talos_version" {
  type        = string
  description = "Talos OS version (e.g. v1.13.0-rc.0). Provided via shared/versions.auto.tfvars."
}

variable "kubernetes_version" {
  type        = string
  description = "Kubernetes version (e.g. v1.36.0). Provided via shared/versions.auto.tfvars."
}
